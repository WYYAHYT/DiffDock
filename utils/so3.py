...
if os.path.exists('/content/drive/MyDrive/.so3_omegas_array4.npy'):
    _omegas_array = np.load('/content/drive/MyDrive/.so3_omegas_array4.npy')
    _cdf_vals = np.load('/content/drive/MyDrive/.so3_cdf_vals4.npy')
    _score_norms = np.load('/content/drive/MyDrive/.so3_score_norms4.npy')
    _exp_score_norms = np.load('/content/drive/MyDrive/.so3_exp_score_norms4.npy')
else:
    ...
    np.save('/content/drive/MyDrive/.so3_omegas_array4.npy', _omegas_array)
    np.save('/content/drive/MyDrive/.so3_cdf_vals4.npy', _cdf_vals)
    np.save('/content/drive/MyDrive/.so3_score_norms4.npy', _score_norms)
    np.save('/content/drive/MyDrive/.so3_exp_score_norms4.npy', _exp_score_norms)
